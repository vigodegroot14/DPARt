...
const translations = {
  nl: {
    ...
    mapExpertiseTitle: "Onze expertise",
    mapSocial: "Sociale wetenschappen",
    mapEngineering: "Milieutechniek",
    mapAi: "AI- en IT-experts",
    mapCommunity: "Praktijkgemeenschap",
    mapYearlyTitle: "Jaarlijkse stappen",
    mapDevelopmentTitle: "Toolontwikkeling",
    mapDevelopmentText: "Tools ontwerpen en bouwen die praktijkproblemen oplossen.",
    mapEvaluationTitle: "Toolevaluatie",
    mapEvaluationText: "Prestaties beoordelen, impact valideren en kwaliteit waarborgen.",
    mapDesignTitle: "Toolontwerp",
    mapDesignText: "Intuïtieve, schaalbare en gebruikersgerichte ontwerpen maken.",
    mapImpactTitle: "Onze impact",
    mapImpactInclusive: "Snellere, inclusievere renovatie",
    mapImpactCost: "Minder menskracht en lagere trainingskosten",
    mapImpactKnowledge: "Efficiënte kennisoverdracht",
    mapPlanTitle: "Het plan",
    mapPlanText: "Een gefaseerde route om te innoveren, valideren en impact op te schalen",
    mapConcept: "Conceptvorming\n(TRL-4)",
    mapKickoff: "Kick-off",
    mapPrototype: "Prototype",
    mapRefinement: "Verfijning",
    mapUpscale: "Opschaling (TRL-7)",
    mapLaunch: "Lancering tool",
    mapBeyond: "Na DPARt",
    mapPhase1: "Fase 1",
    mapPhase2: "Fase 2",
    mapPhase3: "Fase 3",
  ...
  en: {
    ...
    mapExpertiseTitle: "Our Expertise",
    mapSocial: "Social Science",
    mapEngineering: "Environmental Engineering",
    mapAi: "AI and IT experts",
    mapCommunity: "Community of Practice",
    mapYearlyTitle: "Yearly Steps",
    mapDevelopmentTitle: "Tool Development",
    mapDevelopmentText: "Design and build tools that solve real-world challenges.",
    mapEvaluationTitle: "Tool Evaluation",
    mapEvaluationText: "Assess performance, validate impact, and ensure quality.",
    mapDesignTitle: "Tool Design",
    mapDesignText: "Create intuitive, scalable, and user-centered designs.",
    mapImpactTitle: "Our Impact",
    mapImpactInclusive: "Faster, more inclusive renovation",
    mapImpactCost: "Reduction of manpower and training cost",
    mapImpactKnowledge: "Efficient knowledge transfer",
    mapPlanTitle: "The Plan",
    mapPlanText: "A phased roadmap to innovate, validate and scale impact",
    mapConcept: "Conceptualization\n(TRL-4)",
    mapKickoff: "Kick-off",
    mapPrototype: "Prototype",
    mapRefinement: "Refinement",
    mapUpscale: "Upscale (TRL-7)",
    mapLaunch: "Launch tool",
    mapBeyond: "Beyond DPARt",
    mapPhase1: "Phase 1",
    mapPhase2: "Phase 2",
    mapPhase3: "Phase 3",
